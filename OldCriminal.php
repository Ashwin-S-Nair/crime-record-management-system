...
<div id="main-div-2">
    ...
    <?php foreach ($criminals as $criminal) { ?>
        <div class="div-2">
            ...
            <p><b>Address: </b><?php echo htmlspecialchars($criminal['city']); ?></p>
            <p><b>Nationality: </b><?php echo htmlspecialchars($criminal['street']); ?></p>
            <p><b>Crimes Comitted: </b><?php echo htmlspecialchars($criminal['identity']); ?></p>
        </div>
    <?php } ?>
